  ...
  return (
    <header className="site-header">
      ...
      <Link className="header-cta" href="/apply">
        Apply for a complimentary H2W Fit Call <ArrowRight aria-hidden="true" size={17} />
      </Link>
      <button
      ...
      <nav className={open ? "mobile-nav open" : "mobile-nav"} id="mobile-navigation" aria-label="Mobile navigation">
        ...
        <Link href="/apply" onClick={() => setOpen(false)}>Apply for a complimentary H2W Fit Call <ArrowRight aria-hidden="true" size={18} /></Link>
      </nav>
    </header>
  );
}
