  ...
  return (
    <main className="secondary-page legal-shell">
      ...
      <article className="legal-page page-shell" id="page-content">
        ...
        <p>Submitting an application does not create a doctor-patient relationship, guarantee a Fit Call, or guarantee acceptance into a coaching program. Program scope, fees, scheduling, communication expectations, and cancellation terms will be provided separately before enrollment.</p>
