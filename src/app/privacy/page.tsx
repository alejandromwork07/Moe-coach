  ...
  return (
    <main className="secondary-page legal-shell">
      ...
      <article className="legal-page page-shell" id="page-content">
        ...
        <p>Submitted information is used to review coaching applications, assess whether an H2W Fit Call may be appropriate, respond to inquiries, coordinate scheduling, measure campaign effectiveness, and operate Happy Healthy Wealthy. We do not sell personal information.</p>
